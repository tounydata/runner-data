    ...
    >
      ...
      >
        <Field label="Nom" required>
          <input style={inputStyle} value={name} onChange={(e) => setName(e.target.value)} placeholder="Trail du Muguet" required />
        </Field>
        <Field label="Date" required>
          <input style={inputStyle} type="date" value={date} onChange={(e) => setDate(e.target.value)} required />
        </Field>
        <Field label="Distance (km)">
          <input style={inputStyle} type="number" value={distance} onChange={(e) => setDistance(e.target.value)} placeholder="42" min="0" step="0.1" />
        </Field>
        <Field label="D+ (m)">
          <input style={inputStyle} type="number" value={elevation} onChange={(e) => setElevation(e.target.value)} placeholder="1200" min="0" />
        </Field>
        <Field label="Type">
          <select style={inputStyle} value={type} onChange={(e) => setType(e.target.value as RaceType)}>
        ...
        <Field label="Objectif">
          <input style={inputStyle} value={goalTime} onChange={(e) => setGoalTime(e.target.value)} placeholder="4:30:00" />
        </Field>
