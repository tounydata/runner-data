...
export const TERRAIN_TIME_FACTORS = {
...
export function surfaceInfo(k){return SURFACE_MAP[k]||{fr:escapeHTML(k),emoji:'🌍',risk:'medium',col:'var(--text2)'};}

export function _ptSegDist(px,py,ax,ay,bx,by){
...
export async function fetchTerrainSurfaces(points, sections) {
  try {
...
export function slipRisk(surfKey, weather, grade=0) {
